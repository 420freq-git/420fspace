...
enum LedgerTipe: string
{
    ...
    case Pembayaran = 'pembayaran';             // pembayaran hak barang terjual ke vendor (konsinyasi)
    case Cash = 'cash';                         // pembayaran penuh di muka batch cash (beli putus)
    ...
    public function badgeClasses(): string
    {
        return match ($this) {
            ...
            self::Cash => 'bg-indigo-100 text-indigo-800',
