@php
    ...
    // Label invoice ikut brand penonton: TM420 → "Invoice TM420", VOOJAH → "Invoice VOOJAH".
    // 420F melihat tagihan semua brand → "Invoice brand".
    $namaBrand = auth()->user()->brand?->nama;
    $labelInvoice = $namaBrand ? 'Invoice '.$namaBrand : 'Invoice brand';
    ...
    $groups = [
        ...
        ['title' => 'Penjualan', 'items' => [
            ...
            // Dua sumber, dua arah: 'Tarik dari ERP' membawa pesanan VOOJAH dari ERP 420F;
            // yang ini membawa penjualan TM dari ERP TM420 sebagai dasar tagihan produksi.
            ['label' => 'Tarik penjualan TM', 'route' => 'orders.tarik-tm.form', 'ready' => true, 'roles' => [Role::Admin, Role::Tm420],
             'icon' => 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15'],
        ...
        ['title' => 'Keuangan', 'items' => [
            ['label' => $labelInvoice, 'route' => 'invoices.index', 'ready' => true, 'roles' => [Role::Admin, Role::Tm420, Role::Voojah],
        ...
        ['title' => 'Laporan', 'items' => [
            ...
            ['label' => 'Analisis channel', 'route' => 'channel.index', 'ready' => true, 'roles' => [Role::Admin, Role::Tm420, Role::Voojah],
